...
if getgenv().HATDROP and not getgenv().fullbody then
	loadstring(game:HttpGet("https://raw.githubusercontent.com/snea2/skyvr/main/SkyVRHatdrop.lua"))()
	TextLabel.Text = "Ready!"
...
if getgenv().fullbody then
	loadstring(game:HttpGet("https://raw.githubusercontent.com/snea2/skyvr/main/SkyVRFullbody.lua"))()
	TextLabel.Text = "Ready!"
	task.delay(5,function()
		loader:Destroy()
	end)
